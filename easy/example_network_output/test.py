...
draw_lineplot(ax, decimate(np.array(somavs)[0], q=16), dt=network_dt*16,
              T=(0, 25),
              scaling_factor=1.,
              vlimround=16,
              label='E',
...
ax = fig.add_subplot(gs[4])
draw_lineplot(ax, decimate(np.array(somavs)[1], q=16), dt=network_dt*16,
              T=(0, 25),
              scaling_factor=1.,
              vlimround=16,
              label='I',
...
#NOTE: dt is hard set here, might be a bad idea?
...
for i in range(len(f["E:E"][()])):
    ax.scatter(f["E:E"][i][1],f["E:E"][i][2],f["E:E"][i][3],s=4,c='y',marker = "*")
for i in range(len(f["E:I"][()])):
    ax.scatter(f["E:I"][i][1],f["E:I"][i][2],f["E:I"][i][3],s=4,c='g',marker = "*")
for i in range(len(f["I:E"][()])):
    ax.scatter(f["I:E"][i][1],f["I:E"][i][2],f["I:E"][i][3],s=4,c='r',marker = "*")
for i in range(len(f["I:I"][()])):
    ax.scatter(f["I:I"][i][1],f["I:I"][i][2],f["I:I"][i][3],s=4,c='k',marker = "*")
